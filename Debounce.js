...
// You almost certainly have encountered debouncing in your daily lives before (e.g. when entering an elevator).
//  Only after X duration of not pressing the "Door open" button 
...
// Debounce, along with throttle, are among the most common front end interview questions; 
// it's the front end equivalent of inverting a binary tree. Hence you should make sure that you are very familiar with the question.

// Solution
// Given that there's a wait duration before the function can be invoked, we know that we will need a timer, 
// and setTimeout is the first thing that comes to mind.
...
// so we should forward the value of this and function arguments when invoking the original callback functions.
